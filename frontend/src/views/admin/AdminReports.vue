...
const reports = ref([
  { id: 1, number: 'РП-2025-018', company: 'ОсОО «ТехПром»', type: 'Отчёт о нормативах переработки', period: '2024 год', submittedAt: '21.01.2025', status: 'На проверке' },
  { id: 2, number: 'РП-2025-017', company: 'ОАО «СтройМаркет»', type: 'Отчёт о нормативах переработки', period: '2024 год', submittedAt: '20.01.2025', status: 'На проверке' },
  { id: 3, number: 'РП-2025-016', company: 'ОсОО «ПищеПром»', type: 'Отчёт о нормативах переработки', period: '2024 год', submittedAt: '19.01.2025', status: 'Принят' },
  { id: 4, number: 'РП-2025-015', company: 'ИП Асанов Б.К.', type: 'Отчёт о нормативах переработки', period: '2024 год', submittedAt: '18.01.2025', status: 'Принят' },
  { id: 5, number: 'РП-2025-012', company: 'ОсОО «ТехПром»', type: 'Отчёт о нормативах переработки', period: '2023 год', submittedAt: '15.01.2024', status: 'Принят' },
  { id: 6, number: 'РП-2025-010', company: 'ОАО «МегаТорг»', type: 'Отчёт о нормативах переработки', period: '2024 год', submittedAt: '12.01.2025', status: 'Отклонён' },
])
  ...
  >
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <div class="bg-white rounded-xl p-4 shadow-sm border border-[#e2e8f0]">
        ...
        <p class="text-2xl font-bold text-[#1e293b]">523</p>
      </div>
      <div class="bg-white rounded-xl p-4 shadow-sm border border-[#e2e8f0]">
        <p class="text-sm text-[#64748b] mb-1">За текущий месяц</p>
        <p class="text-2xl font-bold text-[#2563eb]">67</p>
      </div>
      <div class="bg-white rounded-xl p-4 shadow-sm border border-[#e2e8f0]">
        <p class="text-sm text-[#64748b] mb-1">На проверке</p>
        <p class="text-2xl font-bold text-[#f59e0b]">23</p>
      </div>
      <div class="bg-white rounded-xl p-4 shadow-sm border border-[#e2e8f0]">
        <p class="text-sm text-[#64748b] mb-1">Отклонено</p>
        <p class="text-2xl font-bold text-[#ef4444]">5</p>
      </div>
    </div>
