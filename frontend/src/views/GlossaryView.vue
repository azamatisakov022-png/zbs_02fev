...
const abbreviations = [
  ...
  { abbr: 'МПРЭТН', full: 'Министерство природных ресурсов, экологии и технического надзора Кыргызской Республики' },
    ...
    <div class="container-main">
      ...
      <div class="text-center mb-10">
        ...
        <p class="text-lg md:text-xl text-[#415861] max-w-2xl mx-auto">
          Сокращения и условные обозначения, используемые в системе АИС «ЦРО»
        </p>
      </div>
        ...
        <div class="bg-[#0e888d]/5 border border-[#0e888d]/20 rounded-xl p-5 flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600">
              ...
              и в автоматизированной информационной системе «Цифровой реестр отходов» Кыргызской Республики.
            </p>
          </div>
        </div>
      </div>
