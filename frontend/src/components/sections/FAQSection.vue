...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Утилизационному сбору подлежат товары из 24 групп: 18 групп товаров (изделия из гофрированной и негофрированной бумаги/картона, масла, шины и покрышки, изделия из резины, пластмассовые упаковочные и прочие изделия, стекло полое, компьютеры и периферийное оборудование, мониторы и телевизионные приёмники, элементы и батареи первичные, аккумуляторы свинцовые, батареи аккумуляторные, осветительное оборудование, крупная и мелкая бытовая техника, холодильное и вентиляционное оборудование, фильтры для ДВС) и 6 групп упаковки (полимерная без галогенов, полимерная с галогенами, комбинированная, из гофрированного картона, из бумаги и негофрированного картона, стеклянная).',
  },
  {
    id: 4,
    question: 'Как подать отчёт о переработке?',
    answer:
      'Отчёт о переработке подаётся через личный кабинет системы «ГП Эко Оператор». Необходимо авторизоваться, выбрать раздел «Отчёты о переработке» и заполнить форму, указав объёмы переработанных отходов по каждой товарной группе за отчётный период.',
  },
  {
    id: 5,
